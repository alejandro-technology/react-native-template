...
./<AGENT_DIR>/skills/create-module/scripts/scaffold-module.sh <module-name> <EntityName>
# Example: # Note: Replace <AGENT_DIR> with your active agent directory (e.g., .agents, .opencode, .claude)
./<AGENT_DIR>/skills/create-module/scripts/scaffold-module.sh orders Order
```

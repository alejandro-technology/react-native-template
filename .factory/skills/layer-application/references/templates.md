# Application Layer — Full Code Templates

> Load this file when you need the complete template for any application layer file.
> Templates: store, queries, mutations, utility-hooks.

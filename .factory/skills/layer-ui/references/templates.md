# UI Layer — Full Code Templates

> Load this file when you need the complete template for any UI layer file.
> Templates: EntitiesListView, EntityDetailView, EntityFormView, EntityList, EntityItem, EntityForm.

## Template: `{Entities}ListView.tsx`
...
## Template: `{Entity}DetailView.tsx`
...
## Template: `components/{Entity}Detail.tsx`
...
## Template: `components/{Entity}List.tsx`
...
## Template: `components/{Entity}Item.tsx`
...
## Template: `components/{Entity}Form.tsx`

...
./<AGENT_DIR>/skills/create-test/scripts/generate-test-boilerplate.sh <type> <Name>
# Types: component | provider | query-hook | mutation-hook | service | store
# Example: # Note: Replace <AGENT_DIR> with your active agent directory (e.g., .agents, .opencode, .claude)
./<AGENT_DIR>/skills/create-test/scripts/generate-test-boilerplate.sh component Button
```

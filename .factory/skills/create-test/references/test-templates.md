# Test Templates — Full Reference

> Load this file when you need the complete template for a specific test type.
> Templates: component, provider, query-hook, mutation-hook, service, store, theme-hook.
